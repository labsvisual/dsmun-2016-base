    ...
    initiatePasswordForgot( request, reply ) {
        ...
        const users = Knex( 'users' ).where( {
            ...
            Knex( 'users' ).where( {
                ...
                the request, please click <a href="http://api.base.dsmun.com/forgot/${ pass_reset_code }">here</a>
                ...
                A password reset request was initiated for this account. If you're the one who initiated
                the request, please click <a href="https://api.base.dsmun.com/forgot/${ pass_reset_code }">here</a>

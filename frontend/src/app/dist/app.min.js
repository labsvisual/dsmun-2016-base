...
angular.module('app').controller('EditConferenceAdminController', ['$stateParams', '$cookies', '$http', '$state', '$window', 'RestApiService', function ($stateParams, $cookies, $http, $state, $window, $rest) {
    ...
    this.AddCountryAllotment = function () {
        ...
        if (_this.conferenceData.countryAllotment && _this.conferenceData.countryAllotment.countries && _this.conferenceData.countryAllotment.countries.length === 5) {

            _this.isMessage = true;
            _this.messageHeader = "Warning!";
            _this.messageText = "You can not add any more delegates. The maximum number of delegates per delegation is 5.";
            _this.messageClass = {
        ...
        if (_this.conferenceData.countryAllotment && _this.conferenceData.countryAllotment.countries) {

            _this.conferenceData.countryAllotment.countries.push({
            ...
            _this.conferenceData.countryAllotment = {
                countries: []
            };
    ...
    this.AddAnnouncement = function () {
        ...
        if (_this.conferenceData.announcements && _this.conferenceData.announcements.notifications) {

            _this.conferenceData.announcements.notifications.push({
            ...
            _this.conferenceData.announcements = {
                notifications: []
            };
    ...
    this.AddGADelegate = function () {
        ...
        if (_this.conferenceData.gaCrisis && _this.conferenceData.gaCrisis.delegates && _this.conferenceData.gaCrisis.delegates.length === 5) {
        ...
        if (_this.conferenceData.gaCrisis && _this.conferenceData.gaCrisis.delegates) {
    ...
    this.AddDelegate = function () {
        ...
        if (_this.conferenceData.delegateInformation) {
            ...
            _this.conferenceData.delegateInformation.delegates = _this.conferenceData.delegateInformation.delegates || [];
...
angular.module('app').controller('DelegateInformationFormController', ['$cookies', '$http', '$stateParams', '$window', 'RestApiService', function ($cookies, $http, $stateParams, $window, $rest) {
    ...
    this.AddDelegate = function () {
        ...
        if (_this.conferenceData.delegateInformation && _this.conferenceData.delegateInformation.delegates.length === 17) {

...
angular.module('app').controller('EditConferenceAdminController', ['$stateParams', '$cookies', '$http', '$state', '$window', 'RestApiService', function ($stateParams, $cookies, $http, $state, $window, $rest) {
    ...
    this.AddCountryAllotment = function () {
        ...
        _this.conferenceData.countryAllotment = _this.conferenceData.countryAllotment || {
            countries: []
        };
    ...
    this.AddAnnouncement = function () {
        ...
        _this.conferenceData.announcements = _this.conferenceData.announcements || {
            notifications: []
        };
    ...
    this.AddGADelegate = function () {
        ...
        _this.conferenceData.gaCrisis = _this.conferenceData.gaCrisis || {
            delegates: []
        };
    ...
    this.AddDelegate = function () {
        ...
        _this.conferenceData.delegateInformation = _this.conferenceData.delegateInformation || {
            delegates: []
        };

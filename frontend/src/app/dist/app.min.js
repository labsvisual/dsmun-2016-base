...
angular.module('app').controller('DashboardController', ['LoginService', 'RestApiService', '$cookies', '$state', function ($login, $rest, $cookies, $state) {
   var _this = this;
...
angular.module('app').controller('EditConferenceAdminController', ['LoginService', '$stateParams', '$cookies', '$http', '$state', '$window', 'RestApiService', function ($login, $stateParams, $cookies, $http, $state, $window, $rest) {
    var _this = this;
